...
import { MenuList } from "../Navbar/data-menu";
// style
      ...
      <footer className="p-4 ">
        <div className="md:flex md:justify-around">
          ...
          <div className="flex justify-evenly w-1/3">
            ...
            <div>
              <h2 className="mb-6 text-lg font-semibold text-gray-200 uppercase dark:text-white">Follow us</h2>
            ...
            <div>
              <h2 className="mb-6 text-lg font-semibold text-gray-200 uppercase dark:text-white">Legal</h2>
              <ul className="text-white dark:text-gray-400">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a
              href="https://github.com/khoadeu25890/fmobile-datn"
