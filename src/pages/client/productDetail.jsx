...
const ProductDetail = () => {
  ...
  return (
    <div>
      {products ? (
        <div className=" bg-white md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
          <div className="">
            <img className="w-full" alt="img of a girl posing" src={products.img} />
            <div className="flex items-center justify-between mt-3 space-x-4 md:space-x-0">
              <img alt="img-tag-one" className="md:w-48 md:h-48 w-full" src={products.img} />
              <img alt="img-tag-one" className="md:w-48 md:h-48 w-full" src={products.img} />
              <img alt="img-tag-one" className="md:w-48 md:h-48 w-full" src={products.img} />
            </div>
          </div>
          <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
            <div className="border-b border-gray-200 pb-6">
              <p className="text-sm leading-none text-gray-600">{products.name}</p>
            ...
            <div className="py-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <div className="flex items-center justify-center">
                <p className="text-sm leading-none text-gray-600 mr-3">{products.price.toLocaleString("vn-VN")}</p>
                <svg
                  className="cursor-pointer"
                  width="6"
                  height="10"
            ...
            <button
              className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-base flex items-center justify-center leading-none
						text-white
						bg-gray-800
						w-full
						py-4
            ...
            <div>
              <div className="border-b py-4 border-gray-200">
                ...
                <div
                  ...
                  id="sect"
                >
                  If you have any questions on how to return your item to us, contact us. <br></br> My phone :
                  0985738577
                </div>
              </div>
            </div>
